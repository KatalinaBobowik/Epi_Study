...
```
## Warning in vegdist(subSamp_250K, method = "bray"): you have empty rows: their
## dissimilarities may be meaningless in method "bray"
```

```
## Warning in vegdist(subSamp_250K, method = "bray"): missing values in results
```
...
```
## Warning in vegdist(allReads, method = "bray"): you have empty rows: their
## dissimilarities may be meaningless in method "bray"
```

```
## Warning in vegdist(allReads, method = "bray"): missing values in results
```
