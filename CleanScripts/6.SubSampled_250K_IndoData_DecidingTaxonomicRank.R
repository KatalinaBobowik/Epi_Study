...
any(taxa_sums(subSampled_250K_Indo_Counts_physeq) == 0)
# [1] TRUE

# remove these OTUs
subSampled_250K_Indo_Counts_physeq <- prune_taxa(taxa_sums(subSampled_250K_Indo_Counts_physeq) > 0, subSampled_250K_Indo_Counts_physeq)
subSampled_250K_Indo_RPM_physeq <- prune_taxa(taxa_sums(subSampled_250K_Indo_RPM_physeq) > 0, subSampled_250K_Indo_RPM_physeq)

# Data preprocessing ------------------------------------

# look at the rate of missingness and number of reads at each rank
Species=tax_glom(subSampled_250K_Indo_Counts_physeq,"Species")
Genus=tax_glom(subSampled_250K_Indo_Counts_physeq,"Genus")
Family=tax_glom(subSampled_250K_Indo_Counts_physeq,"Family")
Order=tax_glom(subSampled_250K_Indo_Counts_physeq,"Order")
Class=tax_glom(subSampled_250K_Indo_Counts_physeq,"Class")
Phylum=tax_glom(subSampled_250K_Indo_Counts_physeq,"Phylum")
Kingdom=tax_glom(subSampled_250K_Indo_Counts_physeq,"Kingdom")
Superkingdom=tax_glom(subSampled_250K_Indo_Counts_physeq,"Superkingdom")
...
missingness_reads=data.frame(Species=c(1:123), Genus=c(1:123),Family=c(1:123),Order=c(1:123),Class=c(1:123),Phylum=c(1:123),Kingdom=c(1:123),Superkingdom=c(1:123))
...
total_OTUs=nrow(tax_table(subSampled_250K_Indo_Counts_physeq))
...
for (rank in taxonomicRanks){
	missingness=sum(tax_table(subSampled_250K_Indo_Counts_physeq)[,rank]=="")/total_OTUs
...
# Do this for RPM
# look at the rate of missingness and number of reads at each rank
Species=tax_glom(subSampled_250K_Indo_RPM_physeq,"Species")
Genus=tax_glom(subSampled_250K_Indo_RPM_physeq,"Genus")
Family=tax_glom(subSampled_250K_Indo_RPM_physeq,"Family")
Order=tax_glom(subSampled_250K_Indo_RPM_physeq,"Order")
Class=tax_glom(subSampled_250K_Indo_RPM_physeq,"Class")
Phylum=tax_glom(subSampled_250K_Indo_RPM_physeq,"Phylum")
Kingdom=tax_glom(subSampled_250K_Indo_RPM_physeq,"Kingdom")
Superkingdom=tax_glom(subSampled_250K_Indo_RPM_physeq,"Superkingdom")
...
missingness_vector=c()
for (rank in taxonomicRanks){
  missingness=sum(tax_table(subSampled_250K_Indo_RPM_physeq)[,rank]=="")/total_OTUs
  missingness_vector=c(missingness_vector, missingness)
}
...
# remove not missing column
SpeciesMissingnessDF=SpeciesMissingnessDF[,!(names(SpeciesMissingnessDF) %in% "notMissing")]
colnames(SpeciesMissingnessDF)=c("Taxonomic_Rank","Perc_Missingness","RPM")
write.table(SpeciesMissingnessDF,file=paste0(outputdir,"SpeciesMissingness_RPMAndPercMissingness.txt"),sep="\t")
