...
```
We now have a phyloseq object of 12 samples with 1026 taxa.
...
```{r, fig.show="hold", out.width="50%", message=FALSE, eval=FALSE}
# Separate species' abundances and taxonomy columns
...
From hierarchical clustering, we can see that samples group by study, which confirms what we saw in PC1 of the PCA analysis.
...
We can dig a little bit deeper and see that differences are actually driven by the Korowai.
