...
rule all:
	input:
		expand("/scratch/punim0586/kat/Bipolar_controlSamples_EpiStudy/{sample}/{sample}_1.fastq.gz", sample=config["samples"]),
		expand("/scratch/punim0586/kat/Bipolar_controlSamples_EpiStudy/{sample}/{sample}_2.fastq.gz", sample=config["samples"]),
...
rule download_files:
	output:
		...
		"/scratch/punim0586/kat/Bipolar_controlSamples_EpiStudy/{sample}/{sample}_2.fastq.gz"
	log:
		"logs/enaDownload/{sample}.log"
	shell:
		"module load web_proxy; ./enaBrowserTools/python3/enaDataGet -f fastq -d /scratch/punim0586/kat/Bipolar_controlSamples_EpiStudy/ {wildcards.sample} || true"
...
rule trimmomatic_pe:
	input:
		r1="/scratch/punim0586/kat/Bipolar_controlSamples_EpiStudy/{sample}/{sample}_1.fastq.gz",
		r2="/scratch/punim0586/kat/Bipolar_controlSamples_EpiStudy/{sample}/{sample}_2.fastq.gz"
	output:
		r1="/scratch/punim0586/kat/Bipolar_controlSamples_EpiStudy_Trimmed/{sample}_1.fastq.gz",
		r2="/scratch/punim0586/kat/Bipolar_controlSamples_EpiStudy_Trimmed/{sample}_2.fastq.gz",
		# reads where trimming entirely removed the mate
		r1_unpaired="/scratch/punim0586/kat/Bipolar_controlSamples_EpiStudy_Trimmed/{sample}_1.unpaired.fastq.gz",
		r2_unpaired="/scratch/punim0586/kat/Bipolar_controlSamples_EpiStudy_Trimmed/{sample}_2.unpaired.fastq.gz"
	log:
