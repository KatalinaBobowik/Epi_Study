...
raw_CCMetagen_data <- read.csv(paste0(inputdir,"Control_SILVA_NoFilteringHumansIncluded_RPM.csv"),check.names=FALSE)
...
raw_CCMetagen_data=raw_CCMetagen_data[-which(raw_CCMetagen_data$Phylum %in% c("Chordata","Arthropoda")),]
...
PaletteEukaryote = colorRampPalette(c("#fd8d3c","#800026"))(7)
