...
raw_CCMetagen_data <- read.csv(paste0(inputdir,"Indo_SILVA_RPM.csv"),check.names=FALSE)
...
PaletteBacteria = colorRampPalette(c("#023858","#74a9cf"))(33)
PaletteEukaryote = colorRampPalette(c("#fd8d3c","#800026"))(10)
...
dev.off()
# get just pathogens with high load
