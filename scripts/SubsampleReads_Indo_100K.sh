...
outdir=/data/scratch/projects/punim0586/kat/101BPIndo_SubSampled_100K
...
inputdir=/data/scratch/projects/punim0586/kat/101BPIndo_SubSampled_100K
outdir=/data/scratch/projects/punim0586/kat/101BPIndo_SubSampled_EndingRemoved_100K
...
inputdir=/data/scratch/projects/punim0586/kat/101BPIndo_SubSampled_EndingRemoved_100K
outdir=/data/scratch/projects/punim0586/kat/101BPIndo_SubSampled_EndingRemoved_100K
for sample in ${inputdir}/*_1.fastq; do
	sampleID=`basename $sample _1.fastq`
...
######
for file in /data/scratch/projects/punim0586/kat/101BPIndonesianSamplesKMA_100K/*.res; do
	sample=`basename $file .res`
	python /data/cephfs/punim0586/kbobowik/CCmetagen/CCMetagen/CCMetagen.py -i /data/scratch/projects/punim0586/kat/101BPIndonesianSamplesKMA_100K/${sample}.res -o /data/scratch/projects/punim0586/kat/101BPIndonesianSamplesCCMetagen_100K/${sample} --depth_unit rpm --mapstat /data/scratch/projects/punim0586/kat/101BPIndonesianSamplesKMA_100K/${sample}.mapstat --depth 1
done
